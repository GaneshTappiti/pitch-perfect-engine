        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl">StartWise</span>
            </div>
            <p className="text-gray-400 leading-relaxed">
              AI-powered startup validation and development platform for modern entrepreneurs.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li>
                <Link to="/guides" className="hover:text-white transition-colors">Startup Guides</Link>
              </li>
              <li>
