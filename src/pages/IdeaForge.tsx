...
const IdeaForge = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Main content */}
      <main className="flex-1 p-0 transition-all duration-300 md:ml-64">
        ...
        {selectedIdea ? (
          <div className="container mx-auto px-4 py-6">
            <div className="flex flex-col lg:flex-row gap-6">
              {/* Side panel for ideas list */}
              <div className="w-full lg:w-64 flex-shrink-0">
                <div className="bg-card rounded-lg border border-border p-4 mb-4 sticky top-[69px]">
