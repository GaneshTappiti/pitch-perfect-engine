          ...
          <Tabs defaultValue="scripts" className="mb-8">
            <TabsList>
              <TabsTrigger 
                ...
                className={activeTab === "scripts" ? "tab-active" : ""}
              >
                Scripts
              </TabsTrigger>
              <TabsTrigger 
                ...
                className={activeTab === "decks" ? "tab-active" : ""}
              >
                Presentation Decks
              </TabsTrigger>
              <TabsTrigger 
                ...
                className={activeTab === "videos" ? "tab-active" : ""}
              >
                Video Pitches
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="scripts" className="mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {scripts.map(script => (
                  <Card key={script.id} className="workspace-card hover:shadow-lg cursor-pointer">
