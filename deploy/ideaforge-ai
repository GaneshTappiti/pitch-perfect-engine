  ...
  try {
    ...
    const chat = model.startChat({
      history: [
        {
          role: 'user',
          parts: [{ text: 'You are an AI assistant specialized in helping entrepreneurs develop and refine their startup ideas. You can help with brainstorming, market analysis, feature suggestions, and business model development. Be creative, practical, and focused on actionable insights.' }],
        },
        {
          role: 'model',
          parts: [{ text: 'I understand. I will help entrepreneurs develop and refine their startup ideas by providing creative, practical, and actionable insights for brainstorming, market analysis, feature suggestions, and business model development.' }],
        },
        ...chatHistory
      ],
    })
